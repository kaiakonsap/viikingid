<?php /* Template Name: Pisipiltide nimekiri */ get_header("header3"); ?>
		...
		<?php $cat=get_post_custom_values('category');?>
							...
							<div id="gallery">
										...
										<div class="gallery_element">
										 ...
										 <div class="gallerykast" style="background: white url('<?php echo get_template_directory_uri(); ?>/img/shadow3.png') 50% 50% no-repeat;height:73px;width:71px;;text-align:center;">
